  ...
  },
  {
    ...
    content: {
      ...
      content: [
        ...
        { type: 'heading', attrs: { level: 2 }, content: [{ type: 'text', text: 'Date & Attendees' }] },
        ...
        { type: 'bulletList', content: [
          { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: '[ ] Action item 1 — Owner' }] }] },
        ]},
      ],
    },
  },
  ...
  },
  {
    ...
    content: {
      ...
      content: [
        ...
        { type: 'bulletList', content: [
          { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: '[ ] Task' }] }] },
        ]},
  ...
  },
  {
    ...
    content: {
      ...
      content: [
        ...
        { type: 'paragraph', content: [{ type: 'text', text: new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) }] },
        { type: 'heading', attrs: { level: 2 }, content: [{ type: 'text', text: '✨ Highlights' }] },
        { type: 'paragraph' },
        { type: 'heading', attrs: { level: 2 }, content: [{ type: 'text', text: '📝 Notes' }] },
        { type: 'paragraph' },
        { type: 'heading', attrs: { level: 2 }, content: [{ type: 'text', text: '🎯 Tomorrow\'s Goals' }] },
        { type: 'bulletList', content: [
          { type: 'listItem', content: [{ type: 'paragraph', content: [{ type: 'text', text: 'Goal 1' }] }] },
        ]},
      ],
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {templates.map((t) => (
            <Card
              ...
              onClick={() => { onSelect(t.content); onOpenChange(false); }}
            >
